...
#ifndef __MRS_REG_ALT_NAME
#define	__MRS_REG_ALT_NAME(op0, op1, crn, crm, op2) \
	s##op0##_##op1##_c##crn##_c##crm##_##op2
#endif

#ifndef MRS_REG_ALT_NAME
#define	MRS_REG_ALT_NAME(reg) \
	__MRS_REG_ALT_NAME(reg##_op0, reg##_op1, reg##_CRn, reg##_CRm, reg##_op2)
#endif

#ifndef SYS_ARG
#define	SYS_ARG(insn, val)	do { (void)(val); } while (0)
#endif

#ifndef SYS
#define	SYS(insn)		do { } while (0)
#endif

#ifndef SYSL
#define	SYSL(insn)		0UL
#endif
