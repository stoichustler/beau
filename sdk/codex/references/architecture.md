...
Set `BEAU_TOOLCHAINS` to the bare-metal toolchain bin directory, then run:
...
- `dumpstat [vm id]`: ARM64 VM/vCPU register, scheduler state, raw guest stack,
  ...
  `beau.debug.out`; offline vCPUs skip stack output.
